...
public class MailUtil {
    ...
    MailUtil(String host, String username, String password) throws Exception {
        this.host = host;
    ...
    MailUtil(MimeMessage msg) {
        this.mimeMsg = msg;
    }

    private void forwardMail(Session session, MailUtil mail) throws Exception, MessagingException {//转发邮件
    ...
    private void replyMail(Session session, MailUtil mail) throws Exception {//回复邮件
...
//        profile.add(FetchProfile.Item.ENVELOPE);
        ...
        for (int i = len - 1; i < len; i++) {
            MailUtil mail = new MailUtil((MimeMessage) (message[i]));
...
//		String username = "******@163.com";
        ...
        String password = "******";
        MailUtil mail = new MailUtil(host, username, password);
        //mail.receiveMail();
    }
